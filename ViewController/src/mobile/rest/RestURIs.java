...
public class RestURIs {
    ...
    private static final String PRICING_INFO_URI = "/v1/PricingAvailability/getPricingInfo";
    ...
    private static final String SEARCH_HISTORY_URI = "/v1/getSearchHistory/getSearchHistory";
